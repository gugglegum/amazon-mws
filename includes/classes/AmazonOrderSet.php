...
class AmazonOrderSet extends AmazonOrderCore implements Iterator{
     ...
     */
    public function __construct($o = null, $mock = false, $m = null, array $config = null){
    ...
    protected function parseXML($xml){
        ...
        foreach($xml->Orders->children() as $key => $order){
            ...
            $this->orderList[$this->index] = new AmazonOrder(null,$order,$this->mockMode,$this->mockFiles,$this->config);
