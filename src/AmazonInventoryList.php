...
class AmazonInventoryList extends AmazonInventoryCore implements \Iterator
{
     ...
     * @param array|string $a A list of Seller SKUs, or a single ID string.
     * @return boolean FALSE if improper input
     */
     ...
     *
     * Submits a `ListInventorySupply` request to Amazon. Amazon will send
     * the list back as a response, which can be retrieved using `getSupply()`.
     ...
     *
     * This method will return FALSE if the list has not yet been filled.
     * If `$j` is specified, it will return a single supply detail. Otherwise
     ...
     * @return array|boolean array of arrays, single detail array, or FALSE if Non-numeric index
     */
