...
class AmazonReportRequestList extends AmazonReportsCore implements \Iterator
{
     ...
     * Fetches a list of Report Requests from Amazon.
     *
     * Submits a `GetReportRequestList` request to Amazon. Amazon will send
     * the list back as a response, which can be retrieved using `getList()`.
     * Other methods are available for fetching specific values from the list.
     * This operation can potentially involve tokens.
     * @param boolean $r When set to FALSE, the function will not recurse, defaults to TRUE
    ...
    /**
     * Sets up options for using `CancelReportRequests`.
     *
     * This changes key options for using `CancelReportRequests`. Please note: because the
     ...
     *
     * Submits a `CancelReportRequests` request to Amazon. Amazon will send
     ...
     * methods as with `fetchRequestList()` and `fetchCount()`.
     * @return boolean FALSE if something goes wrong
     */
     ...
     *
     * Submits a `GetReportRequestCount` request to Amazon. Amazon will send
