...
use gugglegum\phpAmazonMWS\AmazonOrder;
...
class AmazonOrderTest extends \PHPUnit_Framework_TestCase {
    ...
    protected function setUp() {
        resetLog();
        $this->object = new AmazonOrder(include(__DIR__ . '/../test-config.php'), null, null, true, null);
    }
    ...
    public function testSetUp(){
        $obj = new AmazonOrder(include(__DIR__ . '/../test-config.php'), '77', null, true, null);
        ...
        $obj2 = new AmazonOrder(include(__DIR__ . '/../test-config.php'), null, $data->GetOrderResult->Orders->Order, true, null);
