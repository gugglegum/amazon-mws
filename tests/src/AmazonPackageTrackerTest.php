...
use gugglegum\phpAmazonMWS\AmazonPackageTracker;
...
class AmazonPackageTrackerTest extends \PHPUnit_Framework_TestCase {
    ...
    protected function setUp() {
        resetLog();
        $this->object = new AmazonPackageTracker(include(__DIR__ . '/../test-config.php'), null, true, null);
    }
    ...
    public function testSetUp(){
        $obj = new AmazonPackageTracker(include(__DIR__ . '/../test-config.php'), '77', true, null);
