...
use gugglegum\phpAmazonMWS\AmazonProductSearch;
...
class AmazonProductSearchTest extends \PHPUnit_Framework_TestCase {
    ...
    protected function setUp() {
        resetLog();
        $this->object = new AmazonProductSearch(include(__DIR__ . '/../test-config.php'), null, true, null);
    }
    ...
    public function testSetUp(){
        $obj = new AmazonProductSearch(include(__DIR__ . '/../test-config.php'), 'platinum', true, null);
