...
class AmazonOrderTest extends PHPUnit_Framework_TestCase {
    ...
    protected function setUp() {
        resetLog();
        $this->object = new AmazonOrder(null, null, true, null, include(__DIR__.'/../../test-config.php'));
    }
    ...
    public function testSetUp(){
        $obj = new AmazonOrder('77', null, true, null, include(__DIR__.'/../../test-config.php'));
        ...
        $obj2 = new AmazonOrder(null, $data->GetOrderResult->Orders->Order, true, null, include(__DIR__.'/../../test-config.php'));
