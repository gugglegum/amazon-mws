...
class AmazonOrderTest extends PHPUnit_Framework_TestCase {
    ...
    protected function setUp() {
        resetLog();
        $this->object = new AmazonOrder('testStore', null, null, true, null, include(__DIR__.'/../../test-config.php'));
    }
    ...
    public function testSetUp(){
        $obj = new AmazonOrder('testStore', '77', null, true, null, include(__DIR__.'/../../test-config.php'));
        ...
        $obj2 = new AmazonOrder('testStore', null, $data->GetOrderResult->Orders->Order, true, null, include(__DIR__.'/../../test-config.php'));
