...
class AmazonProductSearchTest extends PHPUnit_Framework_TestCase {
    ...
    protected function setUp() {
        resetLog();
        $this->object = new AmazonProductSearch('testStore', null, true, null, include(__DIR__.'/../../test-config.php'));
    }
    ...
    public function testSetUp(){
        $obj = new AmazonProductSearch('testStore', 'platinum', true, null, include(__DIR__.'/../../test-config.php'));
