...
class AmazonProductTest extends PHPUnit_Framework_TestCase {
    ...
    protected function setUp() {
        resetLog();
        $this->object = new AmazonProduct('testStore', null, true, null, include(__DIR__.'/../../test-config.php'));
    }
    ...
    public function testProduct(){
        ...
        $obj = new AmazonProduct('testStore', $p, true, null, include(__DIR__.'/../../test-config.php'));
        $o = $obj->getData();
