...
class AmazonTransportTest extends PHPUnit_Framework_TestCase {
    ...
    protected function setUp() {
        resetLog();
        $this->object = new AmazonTransport('testStore', null, true, null, include(__DIR__.'/../../test-config.php'));
    }

    public function testSetUp() {
        $obj = new AmazonTransport('testStore', '77', true, null, include(__DIR__.'/../../test-config.php'));
