...
class AmazonTransportDocumentTest extends PHPUnit_Framework_TestCase {
    ...
    protected function setUp() {
        resetLog();
        $this->object = new AmazonTransportDocument('testStore', null, true, null, include(__DIR__.'/../../test-config.php'));
    }

    public function testSetUp() {
        $obj = new AmazonTransportDocument('testStore', '77', true, null, include(__DIR__.'/../../test-config.php'));
