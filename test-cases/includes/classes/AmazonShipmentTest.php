...
class AmazonShipmentTest extends PHPUnit_Framework_TestCase {
    ...
    protected function setUp() {
        resetLog();
        $this->object = new AmazonShipment('testStore', true, null, include(__DIR__.'/../../test-config.php'));
    }
    ...
    public function testUsePlan(){
        $planner = new AmazonShipmentPlanner('testStore', true, 'fetchPlan.xml', include(__DIR__.'/../../test-config.php'));
        $a = array();
        $a['Name'] = 'Name';
