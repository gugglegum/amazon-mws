...
class AmazonShipmentItemListTest extends PHPUnit_Framework_TestCase {
    ...
    protected function setUp() {
        resetLog();
        $this->object = new AmazonShipmentItemList('testStore', null, true, null, include(__DIR__.'/../../test-config.php'));
    }
    ...
    public function testSetUp(){
        $obj = new AmazonShipmentItemList('testStore', '77', true, null, include(__DIR__.'/../../test-config.php'));
