...
class AmazonPackageTrackerTest extends PHPUnit_Framework_TestCase {
    ...
    protected function setUp() {
        resetLog();
        $this->object = new AmazonPackageTracker(null, true, null, include(__DIR__.'/../../test-config.php'));
    }
    ...
    public function testSetUp(){
        $obj = new AmazonPackageTracker('77', true, null, include(__DIR__.'/../../test-config.php'));
