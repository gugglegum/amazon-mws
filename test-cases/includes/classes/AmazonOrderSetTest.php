...
class AmazonOrderSetTest extends PHPUnit_Framework_TestCase {
    ...
    protected function setUp() {
        resetLog();
        $this->object = new AmazonOrderSet('testStore', null, true, null, include(__DIR__.'/../../test-config.php'));
    }
    ...
    public function testSetUp(){
        $obj = new AmazonOrderSet('testStore', '77', true, null, include(__DIR__.'/../../test-config.php'));
    ...
    public function testFetchItems(){
        ...
        $o = new AmazonOrderList('testStore', true, null, include(__DIR__.'/../../test-config.php'));
