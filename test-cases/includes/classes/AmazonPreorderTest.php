...
class AmazonPreorderTest extends PHPUnit_Framework_TestCase {
    ...
    protected function setUp() {
        resetLog();
        $this->object = new AmazonPreorder('testStore', null, true, null, include(__DIR__.'/../../test-config.php'));
    }

    public function testSetUp() {
        $obj = new AmazonPreorder('testStore', '77', true, null, include(__DIR__.'/../../test-config.php'));
