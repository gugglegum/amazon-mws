...
class AmazonFeedResultTest extends PHPUnit_Framework_TestCase {
    ...
    protected function setUp() {
        resetLog();
        $this->object = new AmazonFeedResult('testStore', null, true, null, include(__DIR__.'/../../test-config.php'));
    }
    ...
    public function testSetUp(){
        $obj = new AmazonFeedResult('testStore', 77, true, null, include(__DIR__.'/../../test-config.php'));
