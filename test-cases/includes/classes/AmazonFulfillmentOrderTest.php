...
use gugglegum\phpAmazonMWS\AmazonFulfillmentOrder;
...
class AmazonFulfillmentOrderTest extends \PHPUnit_Framework_TestCase {
    ...
    protected function setUp() {
        resetLog();
        $this->object = new AmazonFulfillmentOrder(include(__DIR__.'/../../test-config.php'), null, true, null);
    }
    ...
    public function testSetUp(){
        $obj = new AmazonFulfillmentOrder(include(__DIR__.'/../../test-config.php'), '77', true, null);
