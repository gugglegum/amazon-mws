...
class AmazonFulfillmentOrderTest extends PHPUnit_Framework_TestCase {
    ...
    protected function setUp() {
        resetLog();
        $this->object = new AmazonFulfillmentOrder('testStore', null, true, null, include(__DIR__.'/../../test-config.php'));
    }
    ...
    public function testSetUp(){
        $obj = new AmazonFulfillmentOrder('testStore', '77', true, null, include(__DIR__.'/../../test-config.php'));
