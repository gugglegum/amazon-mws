...
class AmazonOrderItemListTest extends PHPUnit_Framework_TestCase {
    ...
    protected function setUp() {
        resetLog();
        $this->object = new AmazonOrderItemList(null, true, null, include(__DIR__.'/../../test-config.php'));
    }
    ...
    public function testSetUp(){
        $obj = new AmazonOrderItemList('77', true, null, include(__DIR__.'/../../test-config.php'));
