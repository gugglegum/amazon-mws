...
class AmazonOrderItemListTest extends PHPUnit_Framework_TestCase {
    ...
    protected function setUp() {
        resetLog();
        $this->object = new AmazonOrderItemList('testStore', null, true, null, include(__DIR__.'/../../test-config.php'));
    }
    ...
    public function testSetUp(){
        $obj = new AmazonOrderItemList('testStore', '77', true, null, include(__DIR__.'/../../test-config.php'));
