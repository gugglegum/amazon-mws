...
class AmazonServiceStatusTest extends PHPUnit_Framework_TestCase {
    ...
    protected function setUp() {
        resetLog();
        $this->object = new AmazonServiceStatus('testStore', null, true, null, include(__DIR__.'/../../test-config.php'));
    }
    ...
    public function testSetUp(){
        $obj = new AmazonServiceStatus('testStore', 'Inbound', true, null, include(__DIR__.'/../../test-config.php'));
